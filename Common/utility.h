...
enum MESSAGE_TYPE {
    AUTH_REQUEST, AUTH_RESPONSE, AUTH_KEY_EXCHANGE, AUTH_KEY_EXCHANGE_RESPONSE, REQUEST_TO_TALK, REQUEST_OK,
...
enum ERROR_CODE {
    FORWARD_ACCEPT_FAIL, FORWARD_REQUEST_FAIL, PEER_DISCONNECTED
};
/*
 * Utility functions
 */

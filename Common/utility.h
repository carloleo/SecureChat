...
enum MESSAGE_TYPE{AUTH_REQUEST,AUTH_RESPONSE,AUTH_KEY_EXCHANGE,AUTH_KEY_EXCHANGE_RESPONSE,REQUEST_TO_TALK, REQUEST_OK,
        REQUEST_KO,DATA,ERROR,USERS_LIST,USERS_LIST_RESPONSE, PEER_PUB_KEY,PEER_DISCONNECTED,AUTH_PEER_REQUEST,
        AUTH_PEER_RESPONSE,AUTH_PEER_KEY_EX,AUTH_PEER_KEY_EX_RX};
